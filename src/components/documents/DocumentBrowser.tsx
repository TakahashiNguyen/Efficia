...
export const DocumentBrowser: React.FC<DocumentBrowserProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto w-full p-8">
      ...
      {documents.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-32 text-center border-2 border-dashed rounded-xl bg-muted/30">
            ...
            >
              <CardContent className="p-5 flex flex-col h-full">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-sm truncate mb-1" title={doc.fileName}>
                    {doc.fileName}
                  </h3>
