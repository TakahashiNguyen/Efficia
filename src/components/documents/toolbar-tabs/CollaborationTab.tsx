...
export function CollaborationTabTrigger() {
  return <TabsTrigger value="collaboration">Collaboration</TabsTrigger>;
}
...
export const CollaborationTab: React.FC<CollaborationTabProps> = ({
  ...
  return (
    <TabsContent value="collaboration" className="m-0 block p-1">
                      ...
                      <div
                        className={
                          /* tw */ `
                            ...
                            rounded-full border-2 text-xs font-medium
                          `
                        }
                        title={peer}
                      >
